...
export const PRODUCTS: Product[] = [
  // 신한라이프 채널 (자사)
  { id: 'sp-cancer-care',   category: 'cancer',   company: '신한라이프', issuer: 'own', name: '신한케어받는암보험(무배당, 갱신형)', shortName: '신한케어받는암보험', description: '치료비 걱정은 덜고, 암 걱정은 멈추세요' },
  { id: 'sp-one-more-care', category: 'dementia', company: '신한라이프', issuer: 'own', name: '신한치매간병보험 ONE더케어Core(무배당, 해약환급금 미지급형)', shortName: '신한치매간병보험 ONE더케어Core', description: '장기요양과 치매를 준비하는 보험' },
  { id: 'sp-one-core',      category: 'health',   company: '신한라이프', issuer: 'own', name: '신한통합건강보험 원(ONE)Core(무배당, 갱신형)', shortName: '신한통합건강보험 원(ONE)Core', description: '라이프스타일에 맞게 설계가능' },
  { id: 'sp-teeth-plus',    category: 'dental',   company: '신한라이프', issuer: 'own', name: '신한참좋은치아보험 PlusⅢ(무배당, 갱신형)', shortName: '신한참좋은치아보험 PlusⅢ', description: '치아 치료비 든든하게' },
  { id: 'sp-sol-teeth',     category: 'dental',   company: '신한라이프', issuer: 'own', name: '신한SOL쏠한치아보험(무배당)(일반보장형)', shortName: '신한SOL쏠한치아보험 일반보장형', description: '빈번한 치과치료, 핵심 보장으로 든든' },
  { id: 'sp-sol-teeth-kid', category: 'dental',   company: '신한라이프', issuer: 'own', name: '신한SOL쏠한치아보험(무배당)(자녀보장형)', shortName: '신한SOL쏠한치아보험 자녀보장형', description: '우리아이에게 맞춘 치과치료 중심' },
  { id: 'sp-transit-mini',  category: 'injury',   company: '신한라이프', issuer: 'own', name: '신한SOL대중교통보험 mini(무배당)', shortName: '신한SOL대중교통보험 mini', description: '매일타는 대중교통, 365일 안심' },
  { id: 'sp-one-safe',      category: 'injury',   company: '신한라이프', issuer: 'own', name: '신한생활보장보험 ONE더세이프(무배당, 해약환급금 미지급형)', shortName: '신한생활보장보험 ONE더세이프', description: '일상 생활 중 상해사고를 대비' },
  { id: 'sp-sol-pension',   category: 'pension',  company: '신한라이프', issuer: 'own', name: '신한슈퍼SOL연금보험(무배당)', shortName: '신한슈퍼SOL연금보험', description: '연금 강화형으로 은퇴 후 더 든든하게' },

  // 신한은행 채널 (타사 — 전부 가명)
  { id: 'op-a-care',      category: 'cancer',   company: 'A생명',    issuer: 'other', name: '(무)안심케어보험(e)(해약환급금 일부지급형)', shortName: '안심케어보험(e)', description: '암 검사·진단·치료 3단계 보장' },
  { id: 'op-b-checkup',   category: 'health',   company: 'B생명',    issuer: 'other', name: '(무)건강검진 걱정없는 미니보험(모바일)', shortName: '건강검진 걱정없는 미니보험', description: '한 번 납입으로 면책기간 없이 바로 보장' },
  { id: 'op-c-better',    category: 'health',   company: 'C생명',    issuer: 'other', name: '(무)더나은안심보험', shortName: '더나은안심보험', description: '10년간 적용이율 최대 연 3.0%' },
  { id: 'op-b-diabetes',  category: 'health',   company: 'B생명',    issuer: 'other', name: '(무)당뇨플러스건강보험(모바일)', shortName: '당뇨플러스건강보험', description: '당뇨병 진단자금부터 치료비까지' },
  { id: 'op-d-100friend', category: 'health',   company: 'D생명',    issuer: 'other', name: '(무)백년친구 e-안심보험', shortName: '백년친구 e-안심보험', description: '만기까지 보험료 인상없이 보장' },
  { id: 'op-e-cancer',    category: 'cancer',   company: 'E생명',    issuer: 'other', name: '(무)언제나안심암보험(모바일)', shortName: '언제나안심암보험', description: '갱신없이 동일 보험료, 최대 110세까지' },
  // 간병 성격이라 치매·간병 (S2_카테고리체계 §S2-5: "간편간병인·장기요양안심은 치매·간병으로")
  { id: 'op-f-carer',     category: 'dementia', company: 'F손해보험', issuer: 'other', name: '간편간병인보험(무배당) 모바일', shortName: '간편간병인보험', description: '입원 첫날부터 최대 365일 한도' },
  { id: 'op-f-health',    category: 'health',   company: 'F손해보험', issuer: 'other', name: '간편건강보험(무배당) 모바일', shortName: '간편건강보험', description: '암·뇌·심장 주요치료비 10년 최대 2억' },
  { id: 'op-a-injury',    category: 'injury',   company: 'A생명',    issuer: 'other', name: '(무)일상안심상해보험', shortName: '일상안심상해보험', description: '일상 속 상해사고 대비' },
  { id: 'op-d-teeth',     category: 'dental',   company: 'D생명',    issuer: 'other', name: '(무)치아사랑보험', shortName: '치아사랑보험', description: '충치·보철 치료비 보장' },
  { id: 'op-c-ltc',       category: 'dementia', company: 'C생명',    issuer: 'other', name: '(무)장기요양안심보험', shortName: '장기요양안심보험', description: '장기요양등급 판정 시 보장' },
  { id: 'op-f-travel',    category: 'travel',   company: 'F손해보험', issuer: 'other', name: '해외여행보험(무배당)', shortName: '해외여행보험', description: '여행 중 사고·질병 보장' },
  { id: 'op-a-loan',      category: 'etc',      company: 'A생명',    issuer: 'other', name: '(무)대출안심보험', shortName: '대출안심보험', description: '사고 시 남은 대출 상환 지원' },
  { id: 'op-f-golf',      category: 'travel',   company: 'F손해보험', issuer: 'other', name: '골프보험(무배당)', shortName: '골프보험', description: '홀인원·배상책임 보장' },
  { id: 'op-b-variable',  category: 'variable', company: 'B생명',    issuer: 'other', name: '(무)변액연금보험', shortName: '변액연금보험', description: '1일 1회 적합성 진단 후 확인 가능' },
  { id: 'op-d-happy',     category: 'pension',  company: 'D생명',    issuer: 'other', name: '(무)행복연금보험(거치형, 무배당)', shortName: '행복연금보험', description: '5년 유지 시 최저적립액 보장' },
